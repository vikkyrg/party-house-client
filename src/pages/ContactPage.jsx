...
export function ContactPage() {
  return (
    <div className="min-h-screen bg-[#FCF5EB] pt-32 pb-24 relative overflow-hidden font-sans">
      ...
      {/* Background Graphics (Right Edge) */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-8 items-start">
           ...
           <div className="max-w-lg">
             ...
             <h1 className="text-[48px] md:text-[64px] font-heading text-[#1a1c21] font-extrabold leading-[1.1] mb-6 tracking-tight">
                Contact <span className="bg-gradient-to-r from-[#d18428] to-[#991c4d] bg-clip-text text-transparent">Us.</span>
             </h1>
             <p className="text-[15px] font-medium text-[#6b5c52] leading-[1.6] mb-12">
               We'd love to hear from you. Get in touch with our support team for bookings, events, or any questions.
             </p>
             ...
             <div className="space-y-4 mb-16">
                ...
                <div className="bg-[#f4e6d9] rounded-[24px] p-6 flex items-start gap-5">
                   ...
                   <div>
                     <h3 className="text-[16px] font-bold text-[#1a1c21] mb-1">Email Us</h3>
                     <p className="text-[13px] font-medium text-[#6b5c52] mb-2">Our friendly team is here to help.</p>
                ...
                <div className="bg-[#f4e6d9] rounded-[24px] p-6 flex items-start gap-5">
                   ...
                   <div>
                     <h3 className="text-[16px] font-bold text-[#1a1c21] mb-1">Call Us</h3>
                     <p className="text-[13px] font-medium text-[#6b5c52] mb-2">Mon - Sat from 10am to 7pm.</p>
                     <p className="text-[14px] font-bold text-[#8c5211]">+91 8147 897771</p>
                   </div>
                </div>
                ...
                <div className="bg-[#f4e6d9] rounded-[24px] p-6 flex items-start gap-5">
                   ...
                   <div>
                     <h3 className="text-[16px] font-bold text-[#1a1c21] mb-1">Visit Our Office</h3>
                     <p className="text-[13px] font-medium text-[#6b5c52] mb-2 leading-relaxed">
                       123 Cinema Road, Koramangala<br/>Bengaluru, Karnataka 560034<br/>India
                     </p>
                   </div>
                </div>
             </div>
             ...
             <div className="flex flex-wrap items-center justify-between gap-4 w-full">
               <div className="flex items-center gap-2">
                 <Clock className="w-5 h-5 text-[#9e6223]" />
                 <span className="text-[11px] font-bold text-[#6b5c52] leading-tight">Quick<br/>Response</span>
               </div>
               <div className="flex items-center gap-2">
                 <Shield className="w-5 h-5 text-[#9e6223]" />
                 <span className="text-[11px] font-bold text-[#6b5c52] leading-tight">Secure<br/>Your Data</span>
               </div>
               <div className="flex items-center gap-2">
                 <Heart className="w-5 h-5 text-[#9e6223]" />
                 <span className="text-[11px] font-bold text-[#6b5c52] leading-tight">Friendly<br/>Support</span>
               </div>
               <div className="flex items-center gap-2">
                 <Ticket className="w-5 h-5 text-[#9e6223]" />
                 <span className="text-[11px] font-bold text-[#6b5c52] leading-tight">Event<br/>Assistance</span>
               </div>
             </div>
           ...
           <div className="w-full max-w-[440px] lg:mx-auto">
             <div className="bg-white rounded-[32px] p-8 md:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-[#f0e6dd]">
               <h2 className="text-[28px] font-heading text-[#1a1c21] font-bold mb-2 tracking-tight">Send a message</h2>
               <p className="text-[12px] font-medium text-[#6b5c52] mb-8">
               ...
               <form className="space-y-6">
                 ...
                 <div>
                   ...
                   <div className="relative">
                     <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                       <User className="w-4 h-4 text-[#a6998f]" />
                     </div>
                     <input 
                       type="text" 
                       placeholder="Your name"
                       className="w-full bg-white border border-[#ecdcd1] rounded-[16px] pl-11 pr-4 py-3 text-[13px] font-medium text-[#1a1c21] focus:outline-none focus:border-[#8c5211] placeholder:text-[#a6998f]"
                     />
                   </div>
                 </div>
                 ...
                 <div>
                   ...
                   <div className="relative">
                     <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                       <Mail className="w-4 h-4 text-[#a6998f]" />
                     </div>
                     <input 
                       type="email" 
                 ...
                 <div>
                   ...
                   <div className="relative">
                     ...
                     <div className="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                       <ChevronDown className="w-4 h-4 text-[#1a1c21]" />
                     </div>
                   </div>
                 </div>
                 ...
                 <div>
                   ...
                   <div className="relative">
                     <div className="absolute top-3.5 left-4 pointer-events-none">
                       <MessageSquare className="w-4 h-4 text-[#a6998f]" />
                     </div>
                     <textarea 
                       placeholder="How can we help you?"
                       className="w-full bg-white border border-[#ecdcd1] rounded-[16px] pl-11 pr-4 py-3 h-[100px] text-[13px] font-medium text-[#1a1c21] focus:outline-none focus:border-[#8c5211] placeholder:text-[#a6998f] resize-none"
                     ></textarea>
                   </div>
                 </div>
